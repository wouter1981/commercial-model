...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_development_dependency(%q<gem_hadar>, ["~> 1.11.0"])
      s.add_development_dependency(%q<test-unit>, ["~> 3.1"])
      s.add_development_dependency(%q<simplecov>, [">= 0"])
      s.add_runtime_dependency(%q<sync>, [">= 0"])
    else
      s.add_dependency(%q<gem_hadar>, ["~> 1.11.0"])
      s.add_dependency(%q<test-unit>, ["~> 3.1"])
      s.add_dependency(%q<simplecov>, [">= 0"])
      s.add_dependency(%q<sync>, [">= 0"])
    end
  else
    s.add_dependency(%q<gem_hadar>, ["~> 1.11.0"])
    s.add_dependency(%q<test-unit>, ["~> 3.1"])
